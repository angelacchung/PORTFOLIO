                      ...
                      <div class="mb-3 flex-center">
                          <form action="mailto:someone@example.com" method="post" enctype="text/plain">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" placeholder="Tell me what message you got for me!" name="message" size="50" id="message" class="form-control">
                                  <!-- <textarea placeholder="Tell me what message you got for me!" type="text" id="message" name="message"  class="form-control"></textarea> -->
                                </div>
                              <input type="submit" value="Send message" class="mt-4 mb-4 btn btn-lg btn-block btn-primary">
                            </form>
                        <!--Instagram-->
                       <p class="text-muted">Website coded by Angela Chung</p>
